...
export class FlowView {
	constructor(element) {
		...
		this.nodeNameTypeMap = /* @__PURE__ */ new Map();
		this.nodeTypeDefinitionMap = /* @__PURE__ */ new Map();
		this.onViewChange = () => {
		};
		this.textToType = () => {
		};
	...
	addNodeDefinitions({ nodes = [], types = {} }) {
		...
		Object.entries(types).forEach(
			([type, { inputs, outputs }]) => this.nodeTypeDefinitionMap.set(type, { inputs, outputs }),
		);
	}
	clearGraph() {
